...
describe('ReactionMap', () => {
  it('test AddToMap works', () => {
    ...
    // do it!
    blah.AddPiece(new Piece(0, 'outputA', 'type', 1, null, null, 'A', 'B'))
  ...
  it('test RemovePiece works', () => {
    const blah = new PileOfPieces(null)
    for (let i = 0; i < 3; i += 1) {
      blah.AddPiece(new Piece(0, 'outputA', 'piffle', 1, null, null, 'A', 'B'))
    }
    const theOneToRemove = new Piece(0, 'outputA', 'piffle', 1, null, null, 'A', 'B')
  ...
  it('test Clone works', () => {
    ...
    const array = []
    array.push(new Piece(0, 'blah', 'outputA', 1, null, null, 'a', 'a'))
    array.push(new Piece(0, 'blah', 'outputA', 1, null, null, 'b', 'b'))
    array.push(new Piece(0, 'blah', 'outputA', 1, null, null, 'c', 'c'))
