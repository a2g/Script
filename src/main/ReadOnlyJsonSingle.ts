...
export class ReadOnlyJsonSingle implements ReadOnlyJsonInterface,
  ...
  constructor(filename: string) {
    ...
    if (scenario.startingThings !== undefined && scenario.startingThings !== null) {
    ...
    if (scenario.startingThings !== undefined && scenario.startingThings !== null) {
      for (const thing of scenario.startingThings) {
        ...
        if (theThing.startsWith('inv')) { this.startingInvSet.add(theThing) }
        if (theThing.startsWith('flag')) { this.startingFlagSet.add(theThing) }
        if (theThing.startsWith('prop')) { this.startingPropSet.add(theThing) }
      }
