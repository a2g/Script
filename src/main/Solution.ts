...
export class Solution {
  ...
  Clone (): Solution {
    ...
    const clonedRootNodeMap = this.goals.CloneAllRootNodesAndTheirTrees(incompleteNodes)
    this.goals.GetRootNodeByName('flag_win').id = this.goals.GetRootNodeByName('flag_win').id// not sure why do this, but looks crucial!
    const clonedSolution = new Solution(clonedRootNodeMap, this.remainingNodesRepo, this.startingThings, this.restrictionsEncounteredDuringSolving, this.solutionNames)
