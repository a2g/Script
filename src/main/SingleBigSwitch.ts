      ...
      switch (gateType) {
        case _.AUTO_FLAG1_CAUSES_IMPORT_OF_JSON:
          if (solutionNodesMappedByInput != null) {
            ...
            const input = flag1
            solutionNodesMappedByInput.AddToMap(new SolutionNode(id1, id2, output, gateType, count, happs, restrictions, input))
          }
          break
        case _.AUTO_PROP1_BECOMES_PROP2_BY_PROPS:
          if (solutionNodesMappedByInput != null) {
            ...
            const input5 = prop6
            const input6 = prop7
            solutionNodesMappedByInput.AddToMap(new SolutionNode(id1, id2, output, gateType, count, happs, restrictions, input1, input2, input3, input4, input5, input6))
          }
          break
        ...
        case _.AUTO_FLAG1_SET_BY_INVS:
          if (solutionNodesMappedByInput != null) {
            ...
            const input2 = inv2
            const input3 = inv3
            solutionNodesMappedByInput.AddToMap(new SolutionNode(id1, id2, output, gateType, count, happs, restrictions, input1, input2, input3))
          }
          break
        case _.EXAMINE_PROP1_YIELDS_INV1:
          ...
          if (solutionNodesMappedByInput != null) {
            const output = inv1
            const inputA = prop1
            solutionNodesMappedByInput.AddToMap(new SolutionNode(id1, id2, output, gateType, count, happs, restrictions, inputA))
        ...
        case _.FLAG1_SET_BY_LOSING_INV1_WHEN_USED_WITH_PROP1:
          ...
          if (solutionNodesMappedByInput != null) {
            ...
            const inputA = inv1
            const inputB = prop1
            solutionNodesMappedByInput.AddToMap(new SolutionNode(id1, id2, output, gateType, count, happs, restrictions, inputA, inputB))
        ...
        case _.FLAG1_SET_BY_LOSING_INV1_USED_WITH_PROP1_AND_PROPS:
          ...
          happs.array.push(new Happening(Happen.InvGoes, inv1))
          happs.array.push(new Happening(Happen.PropStays, prop1))
          if (prop2.length > 0) { happs.array.push(new Happening(Happen.PropStays, prop2)) }
          if (prop3.length > 0) { happs.array.push(new Happening(Happen.PropStays, prop3)) }
          if (solutionNodesMappedByInput != null) {
            const output = flag1
            const inputA = inv1
            const inputB = prop1
            const inputC = prop2
            const inputD = prop3
            solutionNodesMappedByInput.AddToMap(new SolutionNode(id1, id2, output, gateType, count, happs, restrictions, inputA, inputB, inputC, inputD))
          } else if (objects.Match('Use', inv1, prop1)) {
            return happs
          }
          break
        ...
        case _.FLAG1_SET_BY_USING_INV1_WITH_PROP1_NEED_FLAGS:
          ...
          if (solutionNodesMappedByInput != null) {
            ...
            const inputE = flag4
            const inputF = flag5
            solutionNodesMappedByInput.AddToMap(new SolutionNode(id1, id2, output, gateType, count, happs, restrictions, inputA, inputB, inputC, inputD, inputE, inputF))
          } else if (objects.Match('Use', inv1, prop1)) {
            return happs
          }
          break
